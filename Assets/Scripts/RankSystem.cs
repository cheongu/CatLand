...
public class RankSystem : MonoBehaviour
{
    ...
    private void LoadRankData()
    {
        ...
        {
            Debug.Log("rank" + rankDataArray[i].score);
    ...
    {
        // Instantiate()로 textPrefab 복사체를 생성하, clone 변수에 저장
    ...
    private void CompareRank()
    {
        ...
        currentData.score = PlayerPrefs.GetInt("RankScore");
        currentData.maxCombo = PlayerPrefs.GetInt("RankMaxCombo");
        currentData.normalMoleHitCount = PlayerPrefs.GetInt("RankNormalMoleHitCount");
        currentData.redMoleHitCount = PlayerPrefs.GetInt("RankRedMoleHitCount");
        currentData.blueMoleHitCount = PlayerPrefs.GetInt("RankBlueMoleHitCount");
    ...
    private void SaveRankData()
    {
        for (int i = 0; i < maxRankCount; ++i)
        {
            ...
            PlayerPrefs.SetInt("RankMaxCombo" + 1, rankDataArray[i].maxCombo);
            PlayerPrefs.SetInt("RankNormalMoleHitCount" + 1, rankDataArray[i].normalMoleHitCount);
            PlayerPrefs.SetInt("RankRedMoleHitCount" + 1, rankDataArray[i].redMoleHitCount);
            PlayerPrefs.SetInt("RankBlueMoleHitCount" + 1, rankDataArray[i].blueMoleHitCount);
        }
    }
}
